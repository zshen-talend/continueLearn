...
@Icon(value = CUSTOM, custom = "MySQLInput") // icon is located at src/main/resources/icons/MySQLInput.svg
@PartitionMapper(name = "MySQLInput")
@Documentation("TODO fill the documentation for this mapper")
public class MySQLInputMapper implements Serializable {
    private final MySQLInputMapperConfiguration configuration;
    private final TalendComponentService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public MySQLInputMapper(@Option("configuration") final MySQLInputMapperConfiguration configuration,
    ...
    @Split
    public List<MySQLInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 MySQLInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public MySQLInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new MySQLInputSource(configuration, service, recordBuilderFactory);
    }
}