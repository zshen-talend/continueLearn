...
//
// ============================================================================
package org.talend.berkeleydb.test;
...
import org.talend.berkeleydb.BerkeleyDBStoreOnDiskHandler;
...
public class BerkeleyDBStoreOnDiskHandlerTest {
    ...
    public void testPutData() {
        ...
        Assert.assertEquals(2l, berkeLeyMap.getData(keyList.toArray(new String[0])).get(0));// use same key to get vaule
                                                                                            // and it should be
        // changed to new one
