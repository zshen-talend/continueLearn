...
/**
 * SimpleExample creates a database environment, a database, and a database cursor, inserts and retrieves data.
 */
class SimpleExample {
    ...
    public static void main(String argv[]) {
        ...
        try {
            SimpleExample app = new SimpleExample(numRecordsVal, doInsertArg, envHomeDirectory, startOffset);
            app.run();
    ...
    public void run() throws DatabaseException {
         ...
         * 
         * Notice that we use an explicit transaction to perform this database open, and that we immediately commit the
         * transaction once the database is opened. This is required if we want transactional support for the database.
         * However, we could have used autocommit to perform the same thing by simply passing a null txn handle to
         * openDatabase().
         */
        ...
        /*
         * Insert or retrieve data. In our example, database records are integer pairs.
         */
        ...
        if (doInsert) {
            ...
            for (int i = offset; i < numRecords + offset; i++) {
                /*
                 * Note that autocommit mode, described in the Getting Started Guide, is an alternative to explicitly
                 ...
                 * it might not succeed if the record alread exists and the database was not configured for duplicate
                 * records.
                 */
            ...
            while (cursor.getNext(keyEntry, dataEntry, LockMode.DEFAULT) == OperationStatus.SUCCESS) {
                System.out
                        .println("key=" + IntegerBinding.entryToInt(keyEntry) + " data=" + IntegerBinding.entryToInt(dataEntry));
