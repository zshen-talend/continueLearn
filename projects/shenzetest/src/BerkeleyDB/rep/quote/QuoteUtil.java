...
class QuoteUtil {
    ...
    /**
     * Display a prompt for this node. If this node accepts input, read and return the input.
     * 
     ...
     * @throws IOException
     */
    static String promptAndRead(String name, String nodeName, boolean isMaster, PrintStream promptStream, BufferedReader stdin)
            throws IOException {
    ...
    /**
     * Forwards the request line to the target and prints out the results of the command at the current console.
     * 
     ...
     */
    static void forwardRequest(InetSocketAddress target, String commandLine, PrintStream printStream) throws IOException {
     ...
     */
    static void closeSocketAndStreams(Socket socket, BufferedReader in, PrintStream out) {
        try {
            if (in != null) {
                in.close();
            }
