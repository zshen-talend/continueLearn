...
import db.mapDB.v3_0.MapInterfaceTest;

/**
 * Tests representing the contract of {@link ConcurrentMap}. Concrete
 * subclasses of this base class test conformance of concrete {@link ConcurrentMap} subclasses to that contract.
 *
 * <p>
 * This class is GWT compatible.
 *
 * <p>
 * The tests in this class for null keys and values only check maps for which null keys and values are not allowed.
 * There are currently no {@link ConcurrentMap} implementations that support nulls.
 *
 * @author Jared Levy
 */
@GwtCompatible
public abstract class ConcurrentMapInterfaceTest<K, V> extends MapInterfaceTest<K, V> {
    ...
    protected ConcurrentMapInterfaceTest(boolean allowsNullKeys, boolean allowsNullValues, boolean supportsPut,
            boolean supportsRemove, boolean supportsClear, boolean supportsIteratorRemove) {
        super(allowsNullKeys, allowsNullValues, supportsPut, supportsRemove, supportsClear, supportsIteratorRemove);
    }

    /**
     * Creates a new value that is not expected to be found in {@link #makePopulatedMap()} and differs from the value
     * returned by {@link #getValueNotInPopulatedMap()}.
     *
     * @return a value
