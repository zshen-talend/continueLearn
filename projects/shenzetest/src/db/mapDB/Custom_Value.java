...
public class Custom_Value {
    ...
    /**
     * MapDB uses custom serialization which stores class metadata at single place. Thanks to it is 10x more efficient
     * than standard Java serialization.
     * 
     * Using custom values in MapDB has three conditions:
     * 
     * 1) classes should be immutable. There is instance cache, background serialization etc Modifing your classes after
     * they were inserted into MapDB may leed to unexpected things.
     * 
     * 2) You should implement `Serializable` marker interface. MapDB tries to stay compatible with standard Java
     * serialization.
     * 
