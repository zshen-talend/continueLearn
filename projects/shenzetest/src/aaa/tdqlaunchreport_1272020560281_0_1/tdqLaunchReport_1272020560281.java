...
//
// ============================================================================ 
package aaa.tdqlaunchreport_1272020560281_0_1;
...
/**
 * Job: tdqLaunchReport_1272020560281 Purpose: <br>
 * Description: <br>
 * 
 * @author tal@aa.c
 ...
 * @status
 */
public class tdqLaunchReport_1272020560281 {
	...
	private final String jobName = "tdqLaunchReport_1272020560281";
	private final String projectName = "AAA";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tdqLaunchReport_1272020560281.this,
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				command_tLaunchDQReports_1
						.add("-DREPORT_FILES_TO_EXECUTE="
								+ "/AAA/TDQ_Data Profiling/Reports/cmVwb3J020100423034559_0.1.rep");
	...
	public static void main(String[] args) {
		final tdqLaunchReport_1272020560281 tdqLaunchReport_1272020560281Class = new tdqLaunchReport_1272020560281();

		int exitCode = tdqLaunchReport_1272020560281Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tdqLaunchReport_1272020560281.class
					.getClassLoader().getResourceAsStream(
							"aaa/tdqlaunchreport_1272020560281_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : tdqLaunchReport_1272020560281");
		}
...
/************************************************************************************************
 * 17505 characters generated by Talend Data Quality on the April 23, 2010
 * 7:03:15 PM CST
 ************************************************************************************************/
