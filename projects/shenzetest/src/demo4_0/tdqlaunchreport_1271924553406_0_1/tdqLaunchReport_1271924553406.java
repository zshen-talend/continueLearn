...
//
// ============================================================================ 
package demo4_0.tdqlaunchreport_1271924553406_0_1;
 ...
 * @status
 */
public class tdqLaunchReport_1271924553406 {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tdqLaunchReport_1271924553406.this,
	...
	public static void main(String[] args) {
		final tdqLaunchReport_1271924553406 tdqLaunchReport_1271924553406Class = new tdqLaunchReport_1271924553406();
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tdqLaunchReport_1271924553406.class
					.getClassLoader().getResourceAsStream(
							"demo4_0/tdqlaunchreport_1271924553406_0_1/contexts/"
...
/************************************************************************************************
 * 16712 characters generated by Talend Data Quality on the April 22, 2010
 * 6:23:44 PM CST
 ************************************************************************************************/
