...
/**
 * This class demonstrates how to use Jini as a lookup service for JSR 160 connectors. It shows how to lookup a
 * JMXConnector from the Jini lookup service.
 * <p>
 * See README file and {@link #main(String[])} for more details.
 * <p>
 * Make sure to read the section "Binding with Lookup Services" of the JMX Remote API 1.0 Specification before looking
 * at this example.
 */
public class Client {
     ...
     * <p>
     * If the System property <code>"jini.lookup.url"</code> is provided, its value is the Jini Lookup Service URL.
     * <p>
     * Otherwise, the default URL is assumed to be <code>"jini://localhost"</code>
     * 
     * @return a pointer to the Jini Lookup Service.
     */
    public static ServiceRegistrar getRegistrar() throws IOException, ClassNotFoundException, MalformedURLException {
     ...
     * @param name the AgentName of the JMXConnectors that should be returned. If <var>name</var> is null, then the
     * JMXConnectors for all agents are returned (null is an equivalent for a wildcard).
                ...
                for (MBeanAttributeInfo attr : attrs) {
                    if (attr.isReadable()) {
                        try {
                            ...
                            System.err.println("JmxClient failed to get " + attr.getName());
     ...
     * Program Main
     * <p>
     * Lookup all JMX agents in the Jini Lookup Service and list their MBeans and attributes.
     * <p>
     * You may wish to use the following properties on the Java command line:
     * <ul>
     * <li><code>-Dagent.name=&lt;AgentName&gt;</code>: specifies an AgentName to lookup (default is null, meaning any
     * agent).</li>
     * <li><code>-Djini.lookup.url=&lt;jini-url&gt;</code>: the Jini Lookup Service URL (default is "jini://localhost"),
     * see {@link #getRegistrar()}.</li>
     * <li><code>-Ddebug="true|false"</code>: switch the Client debug flag on/off (default is "false").</li>
     * </ul>
     */
