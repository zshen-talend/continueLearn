package jmx_examples.Security.subject_delegation.mbeans;
 ...
 * 
 * The "SimpleStandard" standard MBean shows how to expose attributes and operations for management by implementing its
 * corresponding "SimpleStandardMBean" management interface.
 * 
 * This MBean has two attributes and one operation exposed for management by a JMX agent: - the read/write "State"
 * attribute, - the read only "NbChanges" attribute, - the "reset()" operation.
 * 
 * This object also has one property and one method not exposed for management by a JMX agent: - the "NbResets"
 * property, - the "getNbResets()" method.
 */
