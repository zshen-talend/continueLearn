package jmx_examples.Security.subject_delegation.client;
...
import jmx_examples.Security.subject_delegation.mbeans.SimpleStandardMBean;
...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            Subject delegationSubject = new Subject(true, Collections.singleton(new JMXPrincipal("delegate")),
            ...
            // server connection
            //
            SimpleStandardMBean proxy = MBeanServerInvocationHandler.newProxyInstance(mbsc, mbeanName, SimpleStandardMBean.class,
                    false);
