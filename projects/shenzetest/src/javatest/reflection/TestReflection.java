...
public class TestReflection {
    ...
    public static void test01() throws ClassNotFoundException {
        ...
        Class c2 = Class.forName("javatest.reflection.TestReflection");
        // 获取指定的包名
    ...
    public static void test02() throws InstantiationException, IllegalAccessException, SecurityException, NoSuchMethodException,
        ...
        Method getMethod = c1.getDeclaredMethod("getUserName", null);
        method.invoke(t1, "Java反射的学习");
        System.out.println("username == " + getMethod.invoke(t1, null));
        method = c1.getDeclaredMethod("setPassWord", String.class);
        getMethod = c1.getDeclaredMethod("getPassWord", null);
        method.setAccessible(true);
        method.invoke(t1, "反射执行某个Private修饰的方法");
        System.out.println("password == " + getMethod.invoke(t1, null));
    }
