...
public class DrawingCodeGenerator implements Opcodes {
    ...
    private void generateClassInfo() {
        writer.visit(V1_7, ACC_PUBLIC + ACC_SUPER, "javatest/compile/asm/DrawingComponent", null, "java/awt/Component", null);
    ...
    public static void main(String[] args) throws IOException {
        ...
        Files.write(Paths.get("bin", "javatest", "compile", "asm", "DrawingComponent.class"), byteCode);
    }
}
