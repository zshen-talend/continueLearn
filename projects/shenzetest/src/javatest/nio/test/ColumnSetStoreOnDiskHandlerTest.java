...
//
// ============================================================================
package javatest.nio.test;

import java.util.ArrayList;
import java.util.List;

import javatest.nio.handler.ColumnSetStoreOnDiskHandler;
...
public class ColumnSetStoreOnDiskHandlerTest {
    ...
    Logger log = Logger.getLogger(ColumnSetStoreOnDiskHandlerTest.class);
    ...
    private List<Object[]> initData() {
        ...
        returnList.add(new Object[] { "name1", "id1", "city1" });
        returnList.add(new Object[] { "name6", "id6", "city6" });
        returnList.add(new Object[] { "name4", "id4", "city4" });
        returnList.add(new Object[] { "name5", "id5", "city5" });
        returnList.add(new Object[] { "name8", "id8", "city8" });
        returnList.add(new Object[] { "name3", "id3", "city3" });
        returnList.add(new Object[] { "name7", "id7", "city7" });
        returnList.add(new Object[] { "name2", "id2", "city2" });
        returnList.add(new Object[] { "name9", "id9", "city9" });
        returnList.add(new Object[] { "name4", "id4", "city4" });
        returnList.add(new Object[] { "name3", "id3", "city3" });
        returnList.add(new Object[] { "name0", "id0", "city0" });
        returnList.add(new Object[] { "name4", "id4", "city4" });
        returnList.add(new Object[] { "name2", "id2", "city2" });
        returnList.add(new Object[] { "name3", "id3", "city3" });
        returnList.add(new Object[] { "name4", "id4", "city4" });
