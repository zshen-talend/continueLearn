package javatest.reference.phantom;
...
public class UseReferenceQueue {
    ...
    public void softReferenceQueue() {
        ...
        SoftReference<ReferencedObject> softRef = new SoftReference<ReferencedObject>(obj, queue);
        obj = null;
    ...
    public void weakReferenceQueue() {
        ...
        WeakReference<ReferencedObject> softRef = new WeakReference<ReferencedObject>(obj1, queue);
        obj1 = null;
        Reference<? extends ReferencedObject> ref = null;
        while ((ref = queue.poll()) == null) {
            System.gc();
    ...
    public void phantomReferenceQueue() {
        ReferenceQueue<ReferencedObject> queue = new ReferenceQueue<>();
        ReferencedObject obj = new ReferencedObject();
        PhantomReference<ReferencedObject> phantomRef = new PhantomReference<ReferencedObject>(obj, queue);
        obj = null;
        Reference<? extends ReferencedObject> ref = null;
        while ((ref = queue.poll()) == null) {
            System.gc();
