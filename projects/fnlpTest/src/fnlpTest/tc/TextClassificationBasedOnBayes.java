...
public class TextClassificationBasedOnBayes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int test = 0; test < percents_cs.length; test++) {
            ...
            System.out.println("Bayes Precision(" + percents_cs[test] + "):" + ((float) count / testset.size()) + "("
                    + count + "/" + testset.size() + ")");
        }
        ...
        for (int test = 0; test < percents_csmax.length; test++) {
            ...
            System.out.println("Bayes Precision(" + percents_csmax[test] + "):" + ((float) count / testset.size())
                    + "(" + count + "/" + testset.size() + ")");
        }
        bayes.noFeatureSelection();
        ...
        for (int i = 0; i < percents_cs.length; i++) {
            System.out.println("Bayes Precision CS(" + percents_cs[i] + "):" + ((float) counts_cs[i] / testset.size())
        ...
        for (int i = 0; i < percents_ig.length; i++) {
            System.out.println("Bayes Precision IG(" + percents_ig[i] + "):" + ((float) counts_ig[i] / testset.size())
